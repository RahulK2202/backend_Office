...
class EmployeeDisplaySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id','department_id','department_name', 'first_name','last_name',"username", 'phone', 'email', 'designation', 'is_blocked']
...
class UserDataSerializer(serializers.ModelSerializer):
    class Meta:
        model = Employee
        fields = ['id', 'username', 'email', 'department', 'designation','first_name','last_name','phone', 'profile_pic']
